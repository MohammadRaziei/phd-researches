...
\begin{frame}
	...
	\begin{minipage}{.6\linewidth}
		...
		\begin{itemize}
			\item 	  with 1 RIS and 1 BS, Wide-Band (WB) pilots
			\item measure the ToAs for the direct
			(i.e. the path BS-UE) and the reflected (i.e. the path BS-RIS-UE) paths
		\end{itemize}
...
\begin{frame}
	...
	\begin{minipage}{.6\linewidth}
		...
		\begin{itemize}
			\item with 1 RIS in the absence of a BS
			\item the RTT and the AoD from the RIS to the UE can be measured
			\item a sphere centered in the RIS and a half-line originated in the RIS
		\end{itemize}
...
\subsubsection{SISO Localization}
\begin{frame}
	\frametitle{SISO Localization}
	\begin{minipage}{.55\linewidth}
		...
		\begin{itemize}
			\item the SISO system with 2 (more than 1) RIS and 1 BS.
			\item  does not allow ToA estimation
			\item The direct BS-UE path does not carry any position information, 
			\item can be performed even when the direct path is blocked
		\end{itemize}
...
\begin{frame}
	...
	\begin{minipage}{.5\linewidth}
		...
		\begin{itemize}
			\item BS is equipped with multiple antennas 
			\item UE is with a single antenna
			\item two half-lines corresponding to the two AoDs 
		\end{itemize}
...
\begin{frame}
	...
	\begin{minipage}{.45\linewidth}
		\begin{figure}
			\centering
			\includegraphics[height=0.4\paperheight]{images/mimo.png}
			\caption{1 RIS, 1 BS, NB}
			\label{fig:mimo}
		\end{figure}
	\end{minipage}
